...
public class FromKafkaToESSyncReduce13 {
  private static final Logger LOG = LoggerFactory
      .getLogger(FromKafkaToESSyncReduce13.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String brokerList = prop.getProperty("kafka.metadata.broker.list");
    ...
    String checkpointDirectory = prop.getProperty("spark.checkpoint.directory");
    ...
    SparkConf sparkConf = new SparkConf().setAppName("FromKafkaToES-Sync13");
