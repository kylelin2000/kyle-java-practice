...
class ReadLines implements Function<Tuple2<String, String>, String> {
  private static final long serialVersionUID =
      9064101206599289859L;
...
class ReduceLines implements Function2<String, String, String> {
...
class RequestQueryProxy implements FlatMapFunction<String, String> {
  private static final Logger LOG = LoggerFactory
  ...
  public Iterable<String> call(String inputMessage) {
    Properties prop = new Properties();
    Path pt = new Path(FromKafkaToESSyncReduce12.propertiesFileName);
    try {
      FileSystem fs = FileSystem.get(new Configuration());
      prop.load(new InputStreamReader(fs.open(pt)));
...
class ResponseFromQueryProxy implements Function<String, Map<String, String>> {
  private static final Logger LOG = LoggerFactory
...
class WriteResultToES implements Function<JavaRDD<Map<String, String>>, Void> {
  private static final Logger LOG = LoggerFactory
